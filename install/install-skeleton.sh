...
rm_and_link "${VSCODIUM_DIR}/vscodium/settings.json"  "${XDG_CONFIG_HOME}/VSCodium/User/settings.json"
rm_and_link "${VSCODIUM_DIR}/vscodium/snippets"       "${XDG_CONFIG_HOME}/VSCodium/User/snippets"
